...
define Device/iyunlink_m87x2
  DEVICE_VENDOR := IYUNLINK
  DEVICE_MODEL := M87X2
  DEVICE_DTS := mt7987a-iyunlink-m87x2
  DEVICE_DTS_DIR := $(DTS_DIR)/mediatek
  DEVICE_DTC_FLAGS := --pad 4096
  DEVICE_DTS_LOADADDR := 0x4ff00000
  DEVICE_PACKAGES := mt798x-2p5g-phy-firmware-internal blkid kmod-fs-ext4
  KERNEL_LOADADDR := 0x40000000
  IMAGES := sysupgrade-emmc.bin
  IMAGE/sysupgrade-emmc.bin := sysupgrade-emmc | append-metadata
endef
TARGET_DEVICES += iyunlink_m87x2
